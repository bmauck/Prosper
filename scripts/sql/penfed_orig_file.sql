...
SELECT
	  'PF_REPORTING_PERIOD'							= 'N/A'
	, 'PERIOD_END_DATE'								= cast(@CutoffMax as datetime)
	, 'COMPANY_SOURCE_NAME'							= 'Prosper'
	, 'SERVICER_SOURCE_NAME'						= 'Prosper'
	, 'LOAN_ID'										= p.LoanNumber
	, 'ASSET_CLASS'									= 'Personal Loans - Unsecured'
	, 'LOAN_PRODUCT_TYPE'							= 'Installment Loan'
	, 'SERVICER_LOAN_PRODUCT_TYPE'					= 'Personal Loan'
	, 'LOAN_SECURED_FLAG'							= 'N'
	, 'LOAN_PURPOSE'								= lca.LoanPurpose
	, 'LOAN_SOURCE'									= 'Purchase'
	, 'SERVICER_LOAN_SOURCE'						= 'Indirect'
	, 'AUTO_MANUAL_APPRVL'							= 'Manual'
	, 'PF_LOAN_PURCH_DATE'							= p.PurchaseDate
	, 'ORIG_FICO_SCORE'								= p.DecisionCredScore
	, 'REFRESH_FICO_SCORE'							= p.RefreshCredScore 
	, 'REFRESH_FICO_DATE'							= p.RefreshCredScoreDate 
	, 'ORIG_CREDIT_GRADE'							= p.ProsperRating
	, 'DTI_BACK_ORIG'								= lca.DTIwoProsperLoan
	, 'DTI_FRONT_ORIG'								= lca.DTIwProsperLoan
	, 'RECOURSE_FLAG'								= 'N/A'
	, 'BORROWER_OCCUP'								= lca.Occupation
	, 'BORROWER_EMPLOYER'							= 'N/A'
	, 'BORROWER_AGE'								= cast(@CutoffMax as datetime) - cast(br.DateOfBirth as datetime)
	, 'BORROWER_STATE_CODE'							= lca.BorrowerState
	, 'CO_BORROWER_FLAG'							= 'N/A'
	, 'CO_BORROWER_FICO_SCORE'						= 'N/A'
	, 'CO_BORROWER_REFRESH_FICO_SCORE'				= 'N/A'
	, 'CO_BORROWER_REFRESH_FICO_DATE'				= 'N/A'
	, 'CO_BORROWER_OCCUP'							= 'N/A'
	, 'CO_BORROWER_EMPLOYER'						= 'N/A'
	, 'FICO_USED_CREDIT_DECISION'					= p.DecisionCredScore
	, 'ORIG_LOAN_AMOUNT'							= p.LoanAmount
	, 'CURR_UPB'									= p.PrincipalBalance
	, 'ORIG_DATE'									= p.OriginationDate
	, 'FIRST_PAY_DATE'								= p.FirstScheduledPayment
	, 'MATURITY_DATE'								= p.MaturityDate
	, 'ORIG_LOAN_TERM'								= p.Term
	, 'WALA'										= p.AgeInMonths
	, 'WAM'											= p.Term - p.AgeInMonths
	, 'NEXT_DUE_DATE'								= p.NextPaymentDueDate
	, 'PAID_THRU_DATE'								= 'N/A'
	, 'INT_PAID_THRU_DATE'							= 'N/A'
	, 'INT_RATE_TYPE'								= 'Fixed'
	, 'ORIG_INT_RATE'								= p.BorrowerRate
	, 'CURR_INT_RATE'								= p.BorrowerRate
	, 'INTEREST_ACCRUAL_BASIS'						= 'Actual/Actual'
	, 'CURRENT_PAYOFF_AMOUNT'						= 'N/A'
	, 'CURR_P&I_AMOUNT_SCHED'						= p.MonthlyPaymentAmount
	, 'ACT_P&I_AMOUNT_PAID'							= p.PrincipalRepaid + p.InterestPaid
	, 'CURR_PRIN_PAID'								= p.PrincipalRepaid
	, 'CURR_INT_PAID'								= p.InterestPaid
	, 'CURR_INT_ACCR'								= p.AccruedInterest
	, 'CURR_FEES_PAID'								= p.CheckFees + p.CollectionFees + p.LateFees + p.ProsperFees + p.ServiceFees
	, 'CURR_FEES_ACCR'								= p.AccruedLatefee + p.AccruedNSFFee + p.AccruedSvcFee
	, 'PAYMNT_FREQNCY'								= 'Monthly'
	, 'BASE_MARGIN_INT_RATE'						= 'N/A'
	, 'ADJ_INT_RATE_INDEX_NAME'						= 'N/A'
	, 'ADJ_INT_RATE_INDEX_RATE'						= 'N/A'
	, 'FIRST_RESET_FREQ'							= 'N/A'
	, 'SUBSEQ_RESET_FREQ'							= 'N/A'
	, 'RATE_LIFE_CAP'								= 'N/A'
	, 'RATE_LIFE_FLOOR'								= 'N/A'
	, 'CURR_DQ_FLAG'								= case when p.DaysPastDue > 0 then 'True' else 'False' end
	, 'DPD'											= p.DaysPastDue
	, 'AMOUNT_PAST_DUE'								= p.PastDueAmount
	, 'CURR_LOAN_STATUS'							= p.LoanStatusDescription
	, 'DATE_PAID_OFF'								= case when p.LoanStatusDescription = 'COMPLETED' then p.LoanClosedDate else NULL end
	, 'AMOUNT_CHRG_OFF'								= p.PrincipalBalanceAtChargeoff
	, 'DATE_CHRG_OFF'								= p.ChargeoffDate
	, 'BKRPT_FLAG'									= case when p.BankruptcyStatus is not NULL then 'True' else 'False' end
	, 'DATE_BKRPT_FILED'							= p.BankruptcyFiledDate
	, 'BKRPT_CHAPTER'								= p.BankruptcyType
	, 'DATE_BKRPT_DISMISSED'						= 'N/A'
	, 'TDR_FLAG'									= case when p.SettlementStatus is not null then 'True' else 'False' end
	, 'DATE_TDR'									= p.SettlementStartDate 
	, 'TDR_IMPAIRMENT_AMT'							= p.SettlementBalAtEnrollment - p.SettlementAgreedPmtAmt
	, 'TDR_HIST_FLAG'								= case when p.SettlementStatus is not null then 'True' else 'False' end
	, 'PARTICIPATION_PERC'							= 'N/A'
	, 'PARTICIPATION_GROSS_INT_PD'					= 'N/A'
	, 'PARTICIPATION_SVC_FEE'						= 'N/A'
	, 'PARTICIPATION_NET_INT_PAID'					= 'N/A'
	, 'PARTICIPATION_PRIN_PAID'						= 'N/A'
	, 'PARTICIPATION_TOTAL_DUE'						= 'N/A'
	, 'PARTICIPATION_CURR_UPB'						= 'N/A'
	, 'PARTICIPATION_ACCR_INT'						= 'N/A'
	, 'LOC_LAST_LIMIT_CHANGE_DATE'					= 'N/A'
	, 'LOC_CREDIT_LIMIT_CHANGE_ACTION'				= 'N/A'
	, 'LOC_DATE_CLOSED'								= 'N/A'
	, 'LOC_ORIG_CRED_LIMIT'							= 'N/A'
	, 'LOC_CURR_CRED_LIMIT'							= 'N/A'
	, 'LOC_CURR_UNFUND_BAL'							= 'N/A'
	, 'TIME_TO_REPAYMENT'							= 'N/A'
	, 'TIME_IN_REPAYMENT'							= 'N/A'
	, 'IN_FORBEARANCE_FLAG'							= 'N/A'
	, 'IN_GRACE_FLAG'								= 'N/A'
	, 'UNDRGRD_GRAD_ORIG_STATUS'					= 'N/A'
	, 'IN_SCHOOL_FLAG'								= 'N/A'
	, 'IN_DEFERMENT_FLAG'							= 'N/A'
	, 'DIRECT_CONS_FLAG'							= 'N/A'
	, 'AMORTIZATION_DELAY'							= 'N/A'
	...
	WHERE
		1=1 
		and p.OriginationDate < @CutoffMin
		and p.OriginationDate >= @CutoffMax
